...
* this model does not cover all existing tools and processes, such as the Activity Map, Job Profile, or Personal Development Plan; it uses these tools to answer the question: "How can I meet the principles and expectations described in the model?".
